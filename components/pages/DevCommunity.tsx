...
⚠️ 重要：你必须在报告中涵盖全部 ${repos.length} 个项目，不得遗漏任何一个！
...
# 🔥 GitHub 热门项目洞察报告 (${repos.length} 个项目)

## 📊 核心趋势总结
（用 2-3 句话概括这批项目反映的技术趋势和开发者关注点）

## 🏆 重点项目详解 (TOP 10)
（从 ${repos.length} 个项目中挑选最有价值的 10 个详细介绍）
...
## 📋 全部项目速览 (${repos.length} 个)
⚠️ 必须列出全部 ${repos.length} 个项目，按类别分组：

### 🤖 AI/机器学习类
| 序号 | 项目名 | Stars | 语言 | 一句话简介 |
|------|--------|-------|------|-----------|
（列出所有 AI 相关项目）
...
- 适当使用 Emoji 增加可读性
- 严禁输出任何开场白或结束语
- ⚠️ 全部项目速览部分必须包含所有 ${repos.length} 个项目，缺一不可！`;
