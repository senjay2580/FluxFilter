    ...
    <div className="h-[calc(100vh-120px)] -m-4 flex flex-col">
      ...
      {showModal && (
        <div className="fixed inset-0 z-[99999] flex items-end sm:items-center justify-center">
          ...
          />
          <div className="relative w-full sm:w-[480px] max-h-[80vh] bg-cyber-dark border border-white/10 rounded-t-2xl sm:rounded-2xl overflow-hidden animate-sheet-in sm:animate-modal-in">
            {/* 弹窗头部 */}
                ...
                filteredVideos.map((video, index) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className={`p-2 rounded-lg transition-all duration-200 flex-shrink-0 btn-press ${
                        copiedId === video.bvid 
